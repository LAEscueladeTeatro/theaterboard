...
const styles = {
  ...
  textarea: {
    ...
    boxSizing: 'border-box',
    minHeight: '80px',
    backgroundColor: 'var(--input-bg-light, #ffffff) !important', // Ensure light background for textarea
    color: 'var(--text-color-dark, #333333) !important', // Ensure dark text for textarea
  },
  button: {
