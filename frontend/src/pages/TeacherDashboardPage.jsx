...
// New Gear Icon (Heroicons Cog-6-tooth)
const GearIcon = () => (
  <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
    <path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 7.889c-.02.12-.115.26-.297.348a7.493 7.493 0 00-.986.57c-.166.1-1.259.115-1.415.039a1.868 1.868 0 00-2.454 1.816v.293a1.868 1.868 0 002.454 1.817 1.868 1.868 0 001.415.039 7.494 7.494 0 00.986.57c.182.088.277.228.297.348l.178 4.072c.15.904.933 1.567 1.85 1.567h1.844c.917 0 1.699-.663 1.85-1.567l.178-4.072c.02-.12.114-.26.297-.348a7.493 7.493 0 00.986-.57c.166-.1 1.259-.115 1.415-.039a1.868 1.868 0 002.454-1.816v-.293a1.868 1.868 0 00-2.454-1.817 1.868 1.868 0 00-1.415-.039 7.494 7.494 0 00-.986-.57c-.182-.088-.277-.228-.297-.348l-.178-4.072A1.87 1.87 0 0012.922 2.25h-1.844zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clipRule="evenodd" />
  </svg>
);
