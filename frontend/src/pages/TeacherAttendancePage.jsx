          ...
          {dailyStatus.bonus_awarded_today ? (
            ...
            <div className="control-group">
              ...
              <select
                ...
                disabled={!!dailyStatus.bonus_awarded_today || isAttendanceEffectivelyClosed || dateForOperations !== getTodayPeruDateString()}
              >
              ...
              <button
                ...
                disabled={!selectedStudentForBonus || !!dailyStatus.bonus_awarded_today || isAttendanceEffectivelyClosed || dateForOperations !== getTodayPeruDateString() || isApplyingBonus}
                  ...
                  <tr key={student.id}>
                    ...
                    <td>
                      {record?.status.startsWith('AUSENCIA') ? (
                        ...
                        >
                          {isRecorded ? 'Corregir' : (dateForOperations !== getTodayPeruDateString() ? 'Registrar' : 'Marcar')}
                        </button>
                      )}
                    </td>
                    <td>
